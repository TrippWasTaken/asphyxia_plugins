...
function getRate(rate) {
  ...
  return $('<span>')
    .append(
      $('<img>')
        .attr('src', getRateAsset(rateArray[0]))
        .attr('style', 'height: 30px;')
    )
    .append(
      $('<img>')
        .attr('src', getRateAsset(rateArray[1]))
        .attr('style', 'height: 30px;')
    )
    .append(
      $('<img>')
        .attr('src', getRateAsset(rateArray[2]))
        .attr('style', 'height: 30px;')
    )
    .append(
      $('<img>')
        .attr('src', 'static/asset/skill_tex_percent.png')
...
function getDifficultyAsset(type, level) {
  ...
  var t = $('<div>')
    .append(
      $('<img>').attr(
        'src',
        'static/asset/difficulty/level_small_' + type + '.png'
      )
    ...
    .append(
      $('<div>')
        ...
        .attr(
          'style',
          'position:absolute;text-align:right;top:1px;width: 100%;padding: 0 1em 0 0;font-family:"testfont";font-weight:"bold";color:white;'
        )
    )
    .attr('style', 'position: relative; width: 100%;');
...
function getCourseInfo(sid, cid, version) {
  ...
  if (courseSeasonFiltered.length == 0) {
    //custom
  ...
  var courseLevelFiltered = courseSeasonFiltered[0].courses.filter(
    function (a) {
      return a.id == cid;
    }
  );
            ...
            $('<div class="course-content">')
              .append(
                $('<table class="is-center">')
                  .append($('<tr>').append($('<td>').append(info.skillName)))
                  .append(
                    $('<tr>').append(
                      $('<td>')
                        .append(
                          ...
                          $('<div style="vertical-align: top;">')
                            ...
                            .append(
                              $(
                                ...
                                getDifficultyAsset(
                                  info.tracks[0].type.toLowerCase(),
                                  info.tracks[0].level
                                )
                              ) //.append(info.tracks[0].level)
                          ...
                          $('<div style="vertical-align: top;">')
                            ...
                            .append(
                              $(
                                ...
                                getDifficultyAsset(
                                  info.tracks[1].type.toLowerCase(),
                                  info.tracks[1].level
                                )
                              ) //.append(info.tracks[1].level)
                          ...
                          $('<div style="vertical-align: top;">')
                            ...
                            .append(
                              $(
                                ...
                                getDifficultyAsset(
                                  info.tracks[2].type.toLowerCase(),
                                  info.tracks[2].level
                                )
                              ) //info.tracks[2].level)
